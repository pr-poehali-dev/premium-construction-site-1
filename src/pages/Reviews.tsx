...
const reviews = [
  ...
  { name: "Сергей Морозов", location: "Балашиха", service: "Кровельные работы", year: "2024", stars: 5, text: "Перекрывали кровлю на старом доме — снимали шифер, ставили мягкую черепицу. Парни приехали со своим инструментом, работали быстро и аккуратно. Цена не выросла, всё как договаривались." },
  { name: "Ольга Кузнецова", location: "Химки", service: "Заборы и ворота", year: "2024", stars: 5, text: "Поставили кирпичный забор с автоматическими воротами. Очень доволен — выглядит солидно, работает безупречно. Ребята грамотные, всё объяснили и показали в работе." },
  { name: "Игорь Петров", location: "Королёв", service: "Фундамент", year: "2023", stars: 5, text: "Делали свайно-винтовой фундамент под каркасный дом. Завезли сваи, закрутили за день, проверили уровни. Цена честная, никаких скрытых доплат. Через год — никаких подвижек." },
  { name: "Анна Сидорова", location: "Люберцы", service: "Фасадные работы", year: "2024", stars: 5, text: "Облицевали дом клинкерным кирпичом 240 м². Получилось красиво, как на картинке у архитектора. Бригада чистоплотная, мусор убирали каждый день. Соседи завидуют." },
  { name: "Виктор Романов", location: "Домодедово", service: "Плиточные работы", year: "2024", stars: 5, text: "Замостили двор брусчаткой 320 м². Сделали с дренажом и бордюрами. Получилось ровно, узор красивый, через зиму ничего не сдвинулось. Молодцы, рекомендую." },
  { name: "Юлия Тимофеева", location: "Щёлково", service: "Беседка с мангалом", year: "2023", stars: 5, text: "Построили беседку 25 м² с мангальной зоной. Сделали по моим эскизам, добавили свои предложения по конструкции — получилось ещё лучше. Семья в восторге, лето провели на даче." },
  { name: "Алексей Никитин", location: "Сергиев Посад", service: "Баня каркасная", year: "2024", stars: 5, text: "Заказывал каркасную баню 30 м² под ключ — парилка, мойка, комната отдыха. Сделали за месяц с нуля. Качество отделки внутри отличное, печку подобрали по моему запросу." },
  { name: "Мария Литвинова", location: "Раменское", service: "Кровельные работы", year: "2023", stars: 5, text: "Меняли мягкую кровлю на двухэтажном доме. Старую сняли, утеплили, проложили новую. Работали в дождь — никаких протечек не было ни во время работ, ни после." },
  { name: "Павел Орлов", location: "Долгопрудный", service: "Фасадные работы", year: "2024", stars: 5, text: "Делали мокрый фасад с утеплителем 280 м². Сэкономили на отоплении, в доме стало заметно теплее. Штукатурка ложится ровно, краска свежая. Гарантия 5 лет — это серьёзно." },
  { name: "Светлана Орехова", location: "Пушкино", service: "Заборы", year: "2024", stars: 5, text: "Установили забор из металлоштакетника 150 п.м. с двумя калитками. Делали в зиму, сваи закручивали в мёрзлый грунт без проблем. Покрасили качественно — за год не выцвело." },
  { name: "Денис Шевцов", location: "Электросталь", service: "Плиточные работы", year: "2023", stars: 5, text: "Замостил террасу и подъездные дорожки. Подбирал плитку вместе с прорабом — он подсказал хороший вариант с морозостойкостью. Прошла зима — всё на месте, без сколов." },
  { name: "Ирина Васильева", location: "Жуковский", service: "Фундамент", year: "2024", stars: 5, text: "Ленточный фундамент под дом 220 м². Сделали с гидроизоляцией и утеплением цоколя. Геологию делали заранее — оказалось правильно, грунт был непростой. Всё стоит ровно." },
  { name: "Роман Гусев", location: "Реутов", service: "Беседка", year: "2024", stars: 5, text: "Построили беседку 18 м² из бруса с обшивкой. Получилось аккуратно, ровно, без зазоров. Покрасили антисептиком — теперь точно надолго. Бригада адекватная, без сюрпризов." },
];
