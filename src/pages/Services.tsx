...
const services = [
  ...
  },
  {
    id: "gazebo",
    icon: "TreePine",
    title: "Пристройки, беседки и террасы",
    desc: "Строим пристройки к дому, деревянные беседки, террасы, перголы, навесы. От лёгких летних до утеплённых всесезонных конструкций.",
